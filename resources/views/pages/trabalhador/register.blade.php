        ...
        <div class="card">
            <div class="card-header row d-flex justify-content-center">
                <div class="col-12 col-md-6">
                    <h3>Registrar-se como Trabalhador</h3>
                </div>
            </div>
            <br><br>
            <div class="card-body">
                <form action="{{ route('trabalhador.store')}}" method="post" class="form">
                    @csrf
                    <div class="row d-flex">
                        <div class="col-12 col-md-4">
                            <strong>Nome Completo:<span style="color: red">*</span></strong>
                            <input type="text" name="nome_completo" title="Escreva seu nome e sobrenome" required class="form-control col-md-10 @error('nome_completo') is-invalid @enderror">
                            @error('nome_completo')
